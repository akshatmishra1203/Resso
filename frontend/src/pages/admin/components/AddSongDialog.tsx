        ...
        <Dialog open={songDialogOpen} onOpenChange={setSongDialogOpen}>
            ...
            <DialogContent className="bg-zinc-900 border-zinc-700 max-h-[80vh] overflow-auto">
                ...
                <div className="space-y-4 py-4">
                    ...
                    <input type="file" accept="image/*" ref={imageInputRef} className="hidden" onChange={(e) => setFiles((prev) => ({ ...prev, image: e.target.files![0] }))} />
                    {/* Image upload Area */}
                    ...
                    <div className="space-y-2">
                        ...
                        <Input value={newSong.title} className="bg-zinc-800 border-zinc-700" onChange={(e) => setNewSong({...newSong, title: e.target.value})}/>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium">Artist</label>
                        <Input value={newSong.artist} className="bg-zinc-800 border-zinc-700" onChange={(e) => setNewSong({...newSong, artist: e.target.value})}/>
                    </div>
                    <div className="space-y-2">

                        ...
                        <div key={user._id} className="cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group ">
                            <div className="flex items-start gap-3">
                                <div className="relative">
                                    ...
                                    <div
                                        className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-zinc-900 bg-zinc-500`} aria-hidden='true' />
                                </div>
                                <div className="flex-1 min-w-0">
                                    ...
                                    {isPlaying ? (
                                        ...
                                        <div className="text-xs text-zinc-400 truncate">by Arijit Singh</div>
                                        </div>
                                    ) : (
...
const LoginPrompt = () => (
    <div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-4">
        <div className="relative">
            <div
                className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-sky-500 rounded-full blur-lg opacity-75 animate-pulse" aria-hidden='true' />
